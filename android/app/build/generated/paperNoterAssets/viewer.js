...
async function exportMemory() {
  ...
  const fileName = `${state.fileName.replace(/\.pdf$/i, "")}.memory.jsonl`;
  if (globalThis.PaperNoterPlatform?.saveTextFile) {
    await globalThis.PaperNoterPlatform.saveTextFile(fileName, await file.text());
    return;
  }
